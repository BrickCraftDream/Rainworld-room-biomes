...
//
    ...
    public void setUpGUIContents() {
        ...
        List<String> splashMessages = Arrays.asList(
                ...
                "Work in progress... Although pretty final",
                "Not final! (jk, it is)",
                "Buttons go here",
                "Insert title here",
                ...
                "Non-non-final interface",
                "Probably not broken anymore",
                "Layout pretty much final",
                //"Draft menu thing",
                ...
                "UX? Never heard of it",
                //"Barebones interface",
                "Minimum viable GUI",
                "UI not in exile",
                //"Scaffolding only",
                "Here until forever",
                "gui.rainworld.nonesense_text_idk_funny_maybe",
