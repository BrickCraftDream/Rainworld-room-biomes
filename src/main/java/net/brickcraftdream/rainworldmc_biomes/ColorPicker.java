...
public class ColorPicker {
    ...
    public static String getColorBufferedImage(BufferedImage image, String xCoord, String yCoord) {
        int x = Integer.parseInt(xCoord);
        int y = Integer.parseInt(yCoord);
        int rgb = image.getRGB(x, y);
        String hexColor = String.format("%06x", rgb).substring(2);
    ...
    public static int combineColorsBufferedImage(BufferedImage imagePath1, String xCoord1, String yCoord1, BufferedImage imagePath2, String xCoord2, String yCoord2, double opacity) {
        long colorValue1 = Long.parseLong(getColorBufferedImage(imagePath1, xCoord1, yCoord1).substring(1), 16);
        long colorValue2 = Long.parseLong(getColorBufferedImage(imagePath2, xCoord2, yCoord2).substring(1), 16);
    ...
    public static Vector3f combineColorsVec3BufferedImage(BufferedImage imagePath1, String xCoord1, String yCoord1, BufferedImage imagePath2, String xCoord2, String yCoord2, double opacity) {
        long colorValue1 = Long.parseLong(getColorBufferedImage(imagePath1, xCoord1, yCoord1).substring(1), 16);
        long colorValue2 = Long.parseLong(getColorBufferedImage(imagePath2, xCoord2, yCoord2).substring(1), 16);
